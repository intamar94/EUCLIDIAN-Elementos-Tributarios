...
class RedactorReglas:
    ...
    def componer(self, d):
        ...
        if not hacer:
            frases.append("Abre el documento para ver el detalle.")
    ...
    def _a_quien(self, d):
        ...
        if oblig == "obligatorio_dian_y_contribuyentes":
            partes.append("Es de obligatorio cumplimiento")
        elif oblig == "obligatorio_dian_solo":
            partes.append("Es doctrina de la DIAN: orienta a sus funcionarios, "
                          "no te obliga como contribuyente")
        elif oblig == "vinculante_jurisprudencia":
            partes.append("Es jurisprudencia vinculante")
