...
export default async function handler(req,res){
  ...
  try{
    ...
    // Solo datos necesarios para consulta; ningún estado interno ni contador de back-office.
    ...
    return res.status(200).json({documentos,total,pagina,porPagina:POR_PAGINA,paginas:Math.max(1,Math.ceil(total/POR_PAGINA)),temas,actualizado:new Date().toISOString()});
